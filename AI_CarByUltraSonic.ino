...
// 초음파 센서 핀 설정
#define TRIGGER_PIN1  22  // 첫 번째 센서의 트리거 핀 설정
#define ECHO_PIN1     24  // 첫 번째 센서의 에코 핀 설정
#define TRIGGER_PIN2  23  // 두 번째 센서의 트리거 핀 설정
#define ECHO_PIN2     25  // 두 번째 센서의 에코 핀 설정
